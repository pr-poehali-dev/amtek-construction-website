...
const Projects = () => {
  const projects = [
    ...
    {
      id: 4,
      title: "Гостиничный комплекс «Катунь Река»",
      location: "ОЭЗ «Бирюзовая Катунь», Алтайский край",
      category: "Туризм и рекреация",
      status: "В разработке",
      area: "Премиум-класс",
      description:
        "Современный гостиничный комплекс с панорамными видами на горы Алтая. Стильные номера с высоким уровнем комфорта",
      image:
        "https://cdn.poehali.dev/files/05606c5f-5303-4e34-9073-428bcd01914b.png",
      features: ["Горные виды", "Премиум-номера", "Туристский кластер"],
    },
  ];
